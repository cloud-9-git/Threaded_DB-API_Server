                             ...
                             int *out_help_requested)
{
    ...
    out_config->dispatch_mode = SERVER_DISPATCH_THREAD_POOL;
...
/* 공통 CLI entry로, dispatch mode와 service name만 바꿔 서버 lifecycle을 실행한다. */
