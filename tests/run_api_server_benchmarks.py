...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--csv-out", default="reports/api_server_benchmark_results.csv")
    parser.add_argument("--raw-csv-out", default="reports/api_server_benchmark_samples.csv")
    parser.add_argument("--report-out", default="reports/api_server_benchmark_report.md")
